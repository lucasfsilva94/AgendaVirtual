<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Template.Master" AutoEventWireup="true"
    CodeBehind="CadastrarContato.aspx.cs" Inherits="Site.CadastrarContato" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>        
        <h4 class="page-header" style="margin: 0px 0px 5px;">Adicionar Contato</h4>
                        ...
                        <div ID="Categoria" runat="server" class="col-xs-5 col-xs-offset-1">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="txtCategoria" runat="server" Width="200px" CssClass="form-control txtCategoria">
                                    <%--<asp:ListItem Text="Selecione a categoria" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="Amigos" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Escola" Value="2"></asp:ListItem>
                                    <asp:ListItem Text="Trabalho" Value="3"></asp:ListItem>
                                    <asp:ListItem Text="Outros" Value="4"></asp:ListItem>--%>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xs-12" style="margin-top:-25px">     
            ...
            <div class="col-xs-3" style="margin-top:10px">
                <asp:LinkButton runat="server" class="btn btn-primary btnCadastrar" ID="btnCadastrar" OnClick="Cadastrar" >
